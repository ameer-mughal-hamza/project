                        ...
                        <div class="form-wrapper">
                            <form action="{{route('doctors.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Select categories" multiple name="categories[]" class=" form-control chosen-select" multiple="multiple">
                                ...
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Select degrees" multiple name="degrees[]" class=" form-control chosen-select" multiple="multiple">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" rows="5" placeholder="Enter description here"></textarea>
                                </div>

                            ...
                            <form action="{{ route('medicine.store') }}" method="POST">
                                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(Session::has('info'))
                                            <span class="help-block" style="color: red;">{{ Session::get('info') }}</span>
                                        @endif
                                    </div>
                                    {{ csrf_field() }}
                                    <p>
                        ...
                        <div class="admin-content-con">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                @foreach($medicine_names as $medicine_name)
                                    <tr>
                                        <td>{{ strtoupper($medicine_name->medicine_name) }}</td>
                                        <td>{{ strtoupper($medicine_name->medicine_type) }}</td>
                                        <td>
                                            <a href=""
                                               class="btn btn-xs btn-warning" role="button">edit</a>
                                            <a
                                                    class="btn btn-xs btn-danger button"
                                                    data-id="{{ $medicine_name->id }}"

...
Route::group( [ 'middleware' => 'auth:admin' ], function () {
	...
	Route::post( '/admin-notifications/get', 'Admin\NotificationController@get' );

	Route::post( '/notification/read', 'Admin\NotificationController@read' );
	Route::get( '/approve_post', [
		'uses' => 'Admin\PostController@approve_post',
		'as'   => 'approve_post'
	] );
	Route::get( 'blog', [
...
Route::group( [ 'middleware' => 'auth:doctor' ], function () {
	...
	Route::post( '/doctor-notifications/get', 'Doctor\NotificationController@get' );

	Route::post( 'appointment_store', [
		'uses' => 'Doctor\DoctorController@
		storeTimings',
		'as'   => 'doctor.appointment.timings'
	] );

	Route::get( 'doctor/blog/post/{id}', [
		'uses' => 'Doctor\PostController@viewPostToDoctor',
		'as'   => 'view.post.to.doctor'
	] );
